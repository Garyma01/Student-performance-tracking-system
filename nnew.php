...
<section class="don-sec" id="NGO">
        <div class="container">
            <div class="heading">
                <h2>SELECT SUBJECT OF YOUR CHOICE</h2>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="don-box">
                       ...
                       <a href="sequiz.php" class="btn1">Start Quiz</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="don-box">
                    <h3>Computer Networks</h3><br>
         <a href="cnquiz.php" class="btn1">Start Quiz</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="don-box">
                        <h3>Artificial Intelligence</h3><br>
                         <a href="aiquiz.php" class="btn1"> Start Quiz</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="don-box">
                      <h3>Database Management System</h3>
                         <a href="dbmsquiz.php" class="btn1">Start Quiz</a>
                    </div>
                </div>
                
                <div class="col-lg-4">
                    <div class="don-box">
                        <h3>Optimization Techniques</h3><br>
                         <a href="otquiz.php" class="btn1">Start Quiz</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="don-box">
                        <h3>Design and analysis of algorithms</h3>
                        <a href="daaquiz.php" class="btn1">Start Quiz</a>
                    </div>
                </div>
                </div>
            </div>
