...
<?php 															
																...
																$fetchqry2 = "UPDATE `dbms` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `dbms` where id='$c'  "; 
...
{    $game1="INSERT INTO save
 ...
 <?php if($_SESSION['clicks']>10){
	...
	$qry3 = "SELECT `ans`, `userans` FROM `dbms`;";
